/**
 * Enterprise Integration Tests - speckle-integration
...
describe('speckle-integration Integration Tests', () => {
  let testEnv: TestEnvironment;
  let service: SpeckleIntegrationService;

  beforeAll(async () => {
    testEnv = await TestEnvironment.setup();
    service = new SpeckleIntegrationService(testEnv.getConfig());
  });
