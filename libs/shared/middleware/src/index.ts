 ...
 * Uses canonical User type from @ectropy/shared/types
 */
...
// Re-export existing middleware for backward compatibility
export { default as authMiddleware } from './auth.middleware.js';
export { PerformanceMonitoringMiddleware as PerformanceMiddleware } from './performance.middleware.js';
