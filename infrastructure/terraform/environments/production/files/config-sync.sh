...
COMPOSE_KEY="production/compose/docker-compose.deploy.yml"
ENV_KEY="production/env/.env.production"
...
NGINX_MAIN_KEY="production/nginx/main.conf"
NGINX_SITE_KEY="production/nginx/ectropy-production.conf"
