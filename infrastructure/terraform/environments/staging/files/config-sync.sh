...
# Phase P3.7: Fortune 500 compliance - Absolute zero-SSH architecture
# ============================================================================
...
SPACES_BUCKET="${SPACES_BUCKET:-ectropy-staging-configs}"
...
NGINX_SITE_FILE="${NGINX_DIR}/ectropy-staging.conf"
